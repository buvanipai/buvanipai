...
import ClickSound from './ClickSound'; // <--- FIXED IMPORT
import { SOCIALS } from '../constants';

const Layout: React.FC = () => {
  // Removed "const playClick = useClickSound()" because the component handles it now
